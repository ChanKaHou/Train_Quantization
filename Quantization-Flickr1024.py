...
class Model(pytorch_lightning.LightningModule):
    ...
    def prepare_data(self):
        self.trainSet = torchvision.datasets.ImageFolder(root='../../data/Flickr1024/train')
        print(self.trainSet) #1600

        self.valSet = torchvision.datasets.ImageFolder(root='../../data/Flickr1024/val')
        print(self.valSet) #224
    ...
    def on_test_end(self):
        with open("Flickr1024_Q="+str(self.Q)+".txt", "w") as file:
